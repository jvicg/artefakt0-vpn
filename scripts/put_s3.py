...
# The state's file, and other important files (such as Ansible's inventory), will be stored into a S3 bucket
...
def main():
    ...
    try: 
        ...
        sys.stderr.write(f"fatal: Error when trying to upload the files: '{e}'\n")
        sys.exit(400)
